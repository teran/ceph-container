...
```sh
# Squid
docker build -t ceph-demo:19.2.6 --build-arg CEPH_VERSION=19.2.6 .

# Tentacle
docker build -t ceph-demo:20.2.4 --build-arg CEPH_VERSION=20.2.4 .
```
...
```sh
docker build -t ceph-demo:19.2.6 \
